...
public class LoadCridController extends Window {
    ...
    public void onCreate(org.zkoss.zk.ui.event.Event event) {
        ...
        while (it.hasNext()) {
            ...
            logger.log(Level.FINEST, "ContentReferencingTableResult: ");
            logger.log(Level.FINEST, "Timestamp: " + crtr.getTime());
    ...
    public void loadCrid() {
        ...
        Combobox cbCrid = (Combobox) getDesktop().getPage("ProgramInformationMain").getFellow("winProgramInformation").getFellow("cbCrid");
