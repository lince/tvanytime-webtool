...

{
	...
	public String toXML(int indent)
	{
		...
		xml += "<mpeg7:MediaRelTimePoint>"+timePoint+"</mpeg7:MediaRelTimePoint>";
		return xml;
	}
	...
	public String toString(int indent)
	{
		...
		sysOut += "MPEG7MediaRelTimePoint: " + timePoint;
	...
	*/
	public Object clone() {
		MPEG7MediaRelTimePoint clone = new MPEG7MediaRelTimePoint();
